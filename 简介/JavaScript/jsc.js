									...
									if(CutImgType=="autocut")
										{
											...
											if(objHeight>objWidth)
												{
													if
														(parentWidth*ratio<parentHeight)
													{
														imgCssText="width:"+parentHeight/ratio+"px!important;height:"+parentHeight+"px!important;"
													}
													else
														{
															imgCssText="width:"+parentWidth+"px!important;height:"+parentWidth*ratio+"px!important;"}$this.css("cssText",imgCssText)
														}
															else
															{
																if(objHeight<objWidth)
																		...
																		if(parentHeight/ratio<parentWidth)
																{
																...
																else
																	{
																		if(parentHeight>parentWidth)
																			{imgCssText="width:"+parentHeight+"px!important;height:"+parentHeight+"px!important;";$this.css("cssText",imgCssText)
																	}
																	else
																		{
																			imgCssText="width:"+parentWidth+"px!important;height:"+parentWidth+"px!important;";
																			$this.css("cssText",imgCssText)}}}objHeight=$this.css("height").replace("px","");
																			...
																			if(objHeight>objWidth)
																					...
																					if(objHeight==parentHeight)
																				{
																					...
																					{
																						if(objHeight<objWidth){if(objWidth==parentWidth)
																							{
																								imgCssText=$this.attr("style")+";margin-top:"+(parentHeight-objHeight)/2+"px!important;border:0px!important;"
																							}
																							else
																							...
																							else
																								{
																								...
																								else
																									{
																										try
																										{
																											...
																											var heightrate=objHeight/parentHeight;var imgwidth=0;
																											var imgheight=0;
															...
															else{imgCssText=$this.attr("style")+";margin-left:"+(parentWidth-imgwidth)/2+"px!important;border:0px!important;"
														}
														$this.css("cssText",imgCssText)
													}
													}catch(e)
